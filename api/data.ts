...
let inMemoryStore: DataStore = {
  ragEntries: [
    ...
    {
      id: 'RAG-WEREWOLF-001',
      title: 'Werewolf Mechanics and Macro Interruptions',
      content: "**Werewolf Mechanics in Bee Swarm Simulator:**\n\n**Important: Bees CANNOT die in Bee Swarm Simulator.** Bees have an energy system, not a health/death system.\n\n**What Werewolves Actually Do:**\n- Werewolves are hostile mobs that spawn in fields (especially Werewolf Field)\n- Werewolves attack the **PLAYER character**, not the bees\n- Bees are immune to damage from mobs including werewolves\n- Bees will attack werewolves to defend the player, consuming energy in the process\n\n**How This Affects Macros:**\n- If the werewolf defeats the player character, the player resets and all bees return to hive to rest for 30 seconds\n- Bees attacking werewolves consume energy - when energy depletes, bees return to hive to rest for 30 seconds\n- This can interrupt macro automation, causing field changes or resets\n- Multiple bees resting reduces pollen collection efficiency\n\n**Solutions:**\n1. Upgrade equipment (masks, guards, boots) to help player survive werewolf attacks\n2. Configure macro to avoid fields where werewolves frequently spawn\n3. Ensure macro can defeat werewolves before player dies/resets\n4. Use bees with high/infinite energy (Exhausted Bee, Photon Bee) to reduce rest interruptions\n\n**Bee Energy System:**\n- Each bee action (gathering pollen, attacking mobs) consumes 1 energy point\n- When energy depletes, bees return to hive to rest for 30 seconds\n- Exhausted Bee and Photon Bee have effectively infinite energy\n- Shocked Bee has shorter rest time\n- If player dies/resets, all bees return to hive to rest for 30 seconds regardless of energy",
      keywords: ['werewolf', 'werewolves', 'macro interruption', 'hostile mob', 'BSS', 'bee energy', 'bee rest', 'player reset', 'equipment'],
    ...
    },
    {
      ...
      content: "**BEE SWARM SIMULATOR - COMPREHENSIVE MECHANICS:**\n\n**Core Gameplay:**\n- Collect pollen from fields using tools and bees\n- Convert pollen to honey at hive (primary currency)\n- Use honey to purchase upgrades, eggs, equipment, hive slots\n- Expand hive by hatching eggs (start with 25 slots, can expand up to 50 slots from Mountain Top Shop)\n- Temporary bees can be summoned through specific game mechanics\n\n**Bees - CRITICAL MECHANICS:**\n- **Bees CANNOT die** - they have an energy system, not health/death\n- Currently 46 bee types that can be discovered and collected\n- Rarities: Common, Rare, Epic, Legendary, Mythic, Event\n- Each bee has unique abilities (pollen collection, combat, special effects)\n- Upgrade/transform bees using Royal Jelly\n- **Energy System:** Each action (gathering pollen, attacking mobs) consumes 1 energy point\n- When energy depletes, bees return to hive to rest for 30 seconds\n- Exhausted Bee and Photon Bee have effectively infinite energy (do not require rest)\n- Shocked Bee has shorter rest time\n- If player dies/resets, all bees return to hive to rest for 30 seconds regardless of energy\n\n**Eggs:**\n- Basic, Silver, Gold, Diamond, Star, Mythic, and event-specific eggs\n- Different eggs hatch into different bee types with varying rarities\n\n**Fields:**\n- Multiple fields with different pollen types (Red, Blue, White, Colorless)\n- Fields include: Sunflower Field, Dandelion Field, Clover Field, Spider Field, Strawberry Field, Bamboo Field, Pineapple Patch, Pine Tree Forest, Cactus Field, Rose Field, Mountain Top Field, Coconut Field, Pepper Patch, Stump Field, Werewolf Field, Mushroom Field, Blue Flower Field, and more\n- Each field has different flower counts and pollen amounts\n- Higher-level fields = more pollen but stronger mobs\n- Some fields are guarded by specific mobs\n\n**Hostile Mobs:**\n- **Werewolves:** Attack the PLAYER character (not bees - bees are immune). Found in Pumpkin Patch and Pine Tree Forest\n- **Vicious Bees:** Periodic spawns that attack players, drop Stingers upon defeat\n- **Field Mobs:** Attack players, not bees - bees are immune to all mob damage\n  - Ladybugs: Found in Mushroom Field\n  - Rhino Beetles: Located in Blue Flower Field\n  - Mantises: Present in Pine Tree Forest\n  - Spiders: Guard various fields\n- Bees attack mobs to defend player, consuming energy in the process\n- Mobs drop loot when defeated (often required for quests)\n- More challenging mobs typically offer better rewards\n- If player dies from mobs, all bees return to hive to rest for 30 seconds\n\n**Planters:**\n- Blue Clay Planter: Basic planter, shorter growth time\n- Red Clay Planter: Better than Blue Clay, more nectar\n- Plastic Planter: Good for early game\n- Cactus Planter: Desert-themed, good nectar production\n- Petal Planter: Advanced planter with better rewards\n- Planters produce nectar over time (provides buffs)\n- Require placement, watering, harvesting (manual or macro)\n\n**Equipment:**\n- **Masks:** Increase pollen collection, provide abilities (Diamond Mask, Demon Mask, etc.)\n- **Guards:** Provide defense for player character, reduce damage from mobs\n- **Boots:** Increase movement speed, provide special abilities\n- **Amulets:** Provide various stat boosts and special effects\n- **Tools:** Collect pollen from fields, can be upgraded\n- **Backpacks:** Store pollen, can be upgraded for more capacity\n- Higher-tier equipment = better efficiency and player survivability\n\n**Quests & NPCs:**\n- **Black Bear:** Main quest giver, provides progression quests\n- **Mother Bear:** Offers quests for rewards\n- **Spirit Bear:** Advanced quests with better rewards\n- **Brown Bear:** Provides quests and rewards\n- Various other NPCs offer specialized quests\n- Completing quests rewards honey, tickets, items, rare bees, eggs\n\n**Tokens & Abilities:**\n- Bees can generate ability tokens that provide various buffs and effects\n- Tokens appear in fields and can be collected\n- Different bees produce different types of tokens\n\n**Additional Mechanics:**\n- Field boosters can temporarily increase pollen collection rates\n- Sprouts in fields can be collected until they burst, rewarding items\n- Codes can be redeemed for rewards\n- Badges can be earned for various achievements\n- Events occur periodically with special rewards",
      keywords: ['BSS', 'bee swarm simulator', 'game mechanics', 'bees', 'energy system', 'bee rest', 'fields', 'pollen', 'honey', 'planters', 'equipment', 'mobs', 'werewolves', 'vicious bee', 'quests', 'NPCs', 'eggs', 'tokens', 'abilities', 'hive slots', '46 bee types', 'masks', 'guards', 'boots', 'amulets', 'tools', 'backpacks'],
      createdAt: new Date().toISOString(),
      createdBy: 'Research-Based Entry',
    },
    {
      ...
      content: "**REVOLUTION MACRO - COMPREHENSIVE GUIDE:**\n\n**About Revolution Macro:**\n- AI-powered automation tool for Bee Swarm Simulator\n- Solo project by developer Liam\n- Free and open-source\n- Cross-platform: Windows 10/11 and newer macOS\n- Modern .NET 8.0/WPF interface\n- Discord integration for notifications\n- Available on GitHub: github.com/nosyliam/revolution-macro\n\n**Key Features:**\n- **AI Gather:** Vision-based ability token detection and collection, adapts to different field layouts and token spawn patterns, priority navigation to important tokens\n- **Vic Hop (Vicious Bee Server Hopping):** Server-hopping to locate and defeat vicious bees, supports searcher alts + main account coordination, AI detection for optimal server selection\n- **Planter Studio:** Nectar collection optimization, timeline scheduling for planter management, automated planting/watering/harvesting, planter rotation\n- **RBC Gather (Robo-bear Challenge):** Automated alt coordination during Robo-bear Challenge events, multi-account support for event optimization\n- **AI Stinger Hop:** Advanced server hopping with AI detection, efficient farming across multiple servers, optimal server selection for resource gathering\n- **AI Pathfinding:** Advanced algorithms determine optimized routes, incorporates shortcuts like portals and cannons, minimizes travel time between tasks\n- **Standard Features:** Pattern gathering (customizable field patterns), auto-conversion (automatic pollen to honey conversion), hive claiming (automatic hive management), field navigation (automatic field switching), quest automation (automated quest completion), dispenser collection (automatic loot collection from dispensers)\n- **RDP Support:** Full Remote Desktop Protocol support for alt account automations, supports Windows RDP and third-party RDP solutions, RDP Wrapper support for Windows Home editions\n\n**Common Issues & Solutions:**\n- **Macro Reset:** Often caused by low-tier gear - upgrade equipment (especially gliders like Mountain Top Glider for travel speed)\n- **Pathfinding Problems:** May need navmesh recalculation - check field navigation settings\n- **Mob Interruptions:** Werewolves/mobs attack player (not bees) - if player dies/resets, all bees return to hive for 30 seconds. Upgrade defense equipment or configure macro to defeat mobs before player dies\n- **Bee Energy Depletion:** Bees attacking mobs consume energy - when depleted, bees rest for 30 seconds. Use high-energy bees (Exhausted Bee, Photon Bee) to reduce interruptions\n- **Display/Rendering Issues:** Set display scaling to 100%, ensure Roblox is in windowed mode (not fullscreen)\n- **Initialization Errors:** Usually corrupt config files - reset configuration or reinstall\n- **Settings Not Saving:** Check file permissions, ensure macro has write access to config directory\n- **Game Window Detection:** Must use windowed mode - fullscreen causes detection issues\n- **Auto-Deposit Conflicts:** Character resetting often caused by auto-deposit conflicts - adjust timing or disable temporarily\n- **Keyboard Layout:** Some features may require keyboard layout set to EN-US for proper detection\n- **Macro Interruptions:** Ensure macro settings align with in-game configurations, regularly update macro and game for compatibility\n\n**Support & Resources:**\n- **Discord Server:** Join the official Revolution Macro Discord server for support, beta testing, guides, and updates\n- **Common Fixes Channel:** The Discord server has a dedicated \"common fixes\" or \"common-fixes\" channel with solutions to frequent issues and troubleshooting steps\n- **GitHub Repository:** Visit github.com/nosyliam/revolution-macro for latest releases and documentation\n- **Tutorials:** Video tutorials available on YouTube for setup and configuration\n\n**Best Practices:**\n- Keep macro updated to latest version\n- Configure settings to match your equipment and goals\n- Use appropriate fields for your bee/equipment level\n- Consider using high-energy bees (Exhausted Bee, Photon Bee) to reduce rest interruptions\n- Test settings before long AFK sessions\n- Monitor macro performance and adjust as needed\n- Check Discord common fixes channel for known issues and solutions",
      keywords: ['revolution macro', 'AI gather', 'vic hop', 'planter studio', 'RBC gather', 'AI stinger hop', 'AI pathfinding', 'troubleshooting', 'macro reset', 'bee energy', 'bee rest', 'display scaling', 'initialization error', 'auto-deposit', 'RDP', 'discord', 'common fixes', 'common-fixes', 'keyboard layout', 'EN-US'],
      createdAt: new Date().toISOString(),
      createdBy: 'Research-Based Entry',
    },
  ],
