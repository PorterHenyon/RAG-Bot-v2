...
SYSTEM_PROMPT = (
    ...
    "\n"
    "**Common Issues:**\n"
    "- Macro reset: Low-tier gear - upgrade equipment (especially gliders like Mountain Top Glider for travel speed)\n"
    ...
    "- Macro interruptions: Ensure macro settings align with in-game configurations, regularly update macro and game\n"
    "\n"
    "For Revolution Macro questions, prioritize knowledge base content and check Discord common fixes channel\n\n"
